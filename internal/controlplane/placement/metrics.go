...
var (
	...
	registryHeartbeatAge      = controlPlaneMetricFactory.NewHistogramVec(prometheus.HistogramOpts{
	...
	registryCandidateCount = controlPlaneMetricFactory.NewHistogramVec(prometheus.HistogramOpts{
	...
	imageAffinityResult = controlPlaneMetricFactory.NewCounterVec(prometheus.CounterOpts{
