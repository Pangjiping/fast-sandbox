...
func (s *Server) ResolveEndpoint(ctx context.Context, request *fastpathv1.ResolveEndpointRequest) (*fastpathv1.ResolveEndpointResponse, error) {
	...
	return &fastpathv1.ResolveEndpointResponse{
		...
		ProxyEndpoint:   strings.TrimRight(s.SandboxProxyBaseURL, "/") + dataplane.RoutePath(request.SandboxUid, request.TargetPort),
...
func (s *Server) CreateSandbox(ctx context.Context, request *fastpathv1.CreateRequest) (_ *fastpathv1.CreateResponse, resultErr error) {
	...
	envelope, err := orchestration.AssignmentForCandidate(candidates[0], 1, apiv1alpha1.InitialInstanceGeneration, 1, runtimeInstanceID)
	if err != nil {
...
func createResponseFromSandbox(sandbox *apiv1alpha1.Sandbox, envelope *assignment.AssignmentEnvelope) *fastpathv1.CreateResponse {
	fastletName := ""
	if envelope != nil {
